...
public class process_manager {
    ...
    public process find_name(String n) {
        if ("INIT".equals(n)) {
            return INIT;
        }
        process p = INIT;
                ...
                if (only == false) {
                    if (free_m(this.name)) {
                        ...
                        if (this.child != null) {
                            ...
                            p.PPID = 0;
                            //dołączenie do dzieci inita
                            if (INIT.child != null) {
                                //dołączenie do najmłodszego
        ...
        public boolean kill(int pid) {
            if (pid == 0) {
                ...
                if (c == 1) {
                    ...
                    //FUNKCJA ZWALNIAJĄCA CAŁĄ PAMIĘĆ
                    System.exit(0);
                }
                if (c == 0) {
